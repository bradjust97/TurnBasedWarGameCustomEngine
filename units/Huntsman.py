...
class Huntsman(Piece):
    ...
    def get_valid_piece_moves(self, game_state):
        return blocked_movement_diamond(HuntsmanEnums.MOVEMENT, self.get_row_number(), self.get_col_number(), game_state)
