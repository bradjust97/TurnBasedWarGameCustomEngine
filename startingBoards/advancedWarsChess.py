...
white_pieces = [white_knight_1, white_footman_1] #, white_catapult_1, white_scoutCavalry_1,
...
black_knight_2 = Knight(15, 15, Player.PLAYER_2)
black_knight_3 = Knight(8, 11, Player.PLAYER_2)
