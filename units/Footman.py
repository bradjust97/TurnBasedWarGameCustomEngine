...
class Footman(Piece):
    ...
    def get_valid_piece_moves(self, game_state):
        ...
        # return total_moves
        return blocked_movement_diamond(FootmanEnums.MOVEMENT, self.get_row_number(), self.get_col_number(), game_state)
